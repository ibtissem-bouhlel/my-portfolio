export default function Home() {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center',
        ...
        Motivated and adaptable graduate
        with strong skills in network security
        and cloud infrastructure.
        Experienced in technical support,
        clear communication, and
        teamwork. Passionate about
        advancing in cybersecurity and
        cloud computing.
        </p>
        ...
        <div style={{ display: 'flex', gap: 40, marginTop: 80 }}>
          {[['2024', 'Fresh Graduate'], ['5+', 'Personal Projects'], ['100%', 'Passion & Motivation']].map(([n, l]) => (
